...
type Dispute = { id: string; reason: string; createdAt: Date; match: { id: string; tournament: { title: string }; participants: { id: string; name: string }[] } };
            ...
            return (
              <article key={dispute.id} className="velox-card overflow-hidden">
                <div className="border-b border-[#29342a] bg-[radial-gradient(circle_at_95%_0%,rgba(197,249,77,0.1),transparent_32%)] px-5 py-5">
                  ...
                  <p className="mt-3 text-sm font-bold text-[#dce8d7]">{participants.map((participant) => participant.name).join(" vs ") || "Participants pending"}</p>
