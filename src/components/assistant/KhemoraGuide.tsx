...
const WELCOME_MESSAGE: ChatMessage = {
  ...
  role: "assistant",
  content:
    "Hey, I’m the Khemora Guide. Ask me about tournaments, payments, matches, teams, or how Khemora works.",
};
  ...
  async function askGuide(question: string) {
    ...
    try {
      ...
      if (!response.ok || !answer) {
        throw new Error("The Khemora Guide could not answer right now.");
      }
        ...
        >
          <header className="relative flex items-center justify-between border-b border-[#2a352b] bg-[radial-gradient(circle_at_15%_0%,rgba(197,249,77,0.18),transparent_38%)] px-4 py-4">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="flex items-center gap-1.5 text-sm font-black text-white">
                  Khemora Guide <Sparkles className="h-3.5 w-3.5 text-[#c5f94d]" aria-hidden />
                </p>
            ...
            <button
              ...
              aria-label="Close Khemora Guide"
            >
          ...
          <div className="border-t border-[#2a352b] bg-[#101811] px-3 pb-3 pt-3">
            ...
            <form onSubmit={handleSubmit} className="flex items-center gap-2">
              <label className="sr-only" htmlFor="velox-guide-question">Ask the Khemora Guide</label>
              <input
                ref={inputRef}
