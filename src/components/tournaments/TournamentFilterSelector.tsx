  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="flex max-h-[75dvh] w-full max-w-lg flex-col rounded-t-[28px] border-t border-[#2e422f] bg-[#0c130e] pb-[max(20px,env(safe-area-inset-bottom))] shadow-[0_-20px_60px_rgba(0,0,0,0.85)] animate-in slide-in-from-bottom-6 duration-200"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Drag Handle */}
            <div className="mx-auto mt-3 h-1.5 w-12 rounded-full bg-[#273729]" aria-hidden />

            {/* Sheet Header */}
            <div className="flex items-center justify-between border-b border-[#1f2d21] px-5 py-3.5">
              <div>
